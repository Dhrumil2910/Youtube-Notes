 ...
 function(e, t, n, i) {
  ...
  t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.form = function(t) {
   ...
   return a.each(function() {
    var m, g, p, h, v, b, y, x, C, w, k, S, T, A, R, P, E, F, O = e(this),
     D = this,
     q = [],
     j = !1;
    F = {
   ...
   return e(this).each(function() {
    ...
    m = {
     ...
     handleKeyboard: function(e) {
      ...
      if (r == s.escape && (m.verbose("Escape key pressed, blurring search field"), m.trigger.blur()), m.is.visible())
       if (r == s.enter) {
       ...
       } else r == s.upArrow ? (m.verbose("Up key pressed, changing active result"), t = o - 1 < 0 ? o : o - 1, i.removeClass(p.active), n.removeClass(p.active).eq(t).addClass(p.active).closest(i).addClass(p.active), e.preventDefault()) : r == s.downArrow && (m.verbose("Down key pressed, changing active result"), t = o + 1 >= a ? o : o + 1, i.removeClass(p.active), n.removeClass(p.active).eq(t).addClass(p.active).closest(i).addClass(p.active), e.preventDefault());
    ...
    C = {
     ...
     can: {
      transition: function(t) {
       var n, o, a, r, s, l, c, u = m.animation,
